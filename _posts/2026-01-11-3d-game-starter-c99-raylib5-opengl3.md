...
- OpenGL 3.30
- CMake v3.28.3
- Visual Studio 2022 MVS

## Screenshots

Note: Captured on mid-tier PC from 2020 (GPU: RTX-2060 with 6 GB VRAM, CPU: Intel i5-9600K, RAM: 32 GB).

![alt text](/upload/20260111-screenshot-raylib.png)

![alt text](/upload/20260111-screenshot-unreal.jpg)

![alt text](/upload/20260111-screenshot-raylib-2.png)

![alt text](/upload/20260111-diagrams-1.png)

![alt text](/upload/20260111-diagrams-2.png)
...
![alt text](/upload/20260111-thumb-vs-debug.png)
...
![alt text](/upload/20260111-thumb-vsc-debug.png)
...
![alt text](/upload/20260111-faq-character-lighting.png)
...
![alt text](/upload/20260111-faq-performance-fps.png)

![alt text](/upload/20260111-faq-performance-fps-2.png)

## Project History

![alt text](/upload/20260111-history-screenshot.png)
